...
const FEATURES = [
  ...
  { icon: Globe, title: '18 Traduções', desc: 'Multiple versões em português e inglês' },
  { icon: Heart, title: 'Favoritos', desc: 'Salve versículos com cores e anotações' },
  { icon: MessageCircle, title: 'Anotações', desc: 'Editor de texto com tags coloridas' },
  { icon: Sparkles, title: 'Meditação Diária', desc: 'Reflexões baseadas na Palavra de Deus' },
  { icon: PenLine, title: 'Reflexões', desc: 'Diário pessoal de descobertas bíblicas' },
  { icon: Calendar, title: 'Planos de Leitura', desc: 'Bíblia em 1 ano, NT em 90 dias e mais' },
  { icon: Trophy, title: 'Gamificação', desc: 'XP, níveis e conquistas' },
  { icon: BarChart3, title: 'Estatísticas', desc: 'Sequência, capítulos, progresso' },
  { icon: Download, title: 'Modo Offline', desc: 'Dados salvos localmente com IndexedDB' },
  { icon: Cloud, title: 'Backup', desc: 'Exportar e importar dados' },
  { icon: Crown, title: 'Premium', desc: 'Recursos exclusivos' },
];
