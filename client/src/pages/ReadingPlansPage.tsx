...
const DEFAULT_PLANS: PlanData[] = [
  {
    ...
    description:
      'Leia toda a Bíblia seguindo um plano cronológico de 365 dias com leituras do AT e NT.',
    totalDays: 365,
    currentDay: 0,
    category: 'Completo',
  },
  {
    ...
    description: 'Leia todos os 27 livros do Novo testamento em 90 dias.',
    totalDays: 90,
    currentDay: 0,
    category: 'Completo',
  },
  {
    ...
    description: 'Leia os 4 evangelhos (Mateus, Marcos, Lucas e João) em 30 dias.',
    totalDays: 30,
    currentDay: 0,
    category: 'Evangelhos',
  },
  {
    ...
    description: 'Estudo profundo de Mateus 5-7 com reflexões devocionais diárias.',
    totalDays: 14,
    currentDay: 0,
    category: 'Devocional',
  },
  {
    ...
    description: 'Uma seleção de Salmos para momentos de dificuldade e busca por paz.',
    totalDays: 30,
    currentDay: 0,
    category: 'Temático',
  },
  {
    ...
    description: 'Explore as epístolas paulinas e seus ensinamentos práticos para a vida cristã.',
    totalDays: 60,
    currentDay: 0,
    category: 'Estudo',
  },
  {
    ...
    description: 'Um capítulo de Provérbios por dia para sabedoria prática.',
    totalDays: 31,
    currentDay: 0,
    category: 'Sabedoria',
  },
  {
    id: '8',
    title: 'Pentecostais',
    description: 'Estude os livros Pentecostais: Atos e os dons do Espírito.',
    totalDays: 30,
    currentDay: 0,
  ...
  },
  {
    ...
    description: 'Leia Josué, Juízes, Rute, Samuel, Reis e Crônicas.',
    totalDays: 60,
    currentDay: 0,
    category: 'Histórico',
  },
  {
    ...
    description: 'Mergulhe nos livros poéticos: Job, Salmos, Provérbios, Eclesiastes e Cantares.',
    totalDays: 90,
    currentDay: 0,
    category: 'Poesia',
  },
  {
    ...
    description: 'Estude Isaías, Jeremias, Lamentações, Ezequiel e Daniel.',
    totalDays: 60,
    currentDay: 0,
    category: 'Profecia',
  },
      ...
      <header className="flex flex-col md:flex-row justify-between gap-4">
        <div className="space-y-2">
          ...
          <p className="text-lg text-muted-foreground">
            Cresça em fé com leituras guiadas e devocionais diários.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-gradient-to-br from-orange-500/10 to-amber-500/10 border border-orange-500/20 rounded-2xl p-5 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground font-medium">Sequência de leitura</p>
          </div>
        </div>
        <div className="bg-card border rounded-2xl p-5 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground font-medium">Planos em andamento</p>
          </div>
        </div>
        <div className="bg-card border rounded-2xl p-5 flex items-center gap-4">
          ...
          <div>
            <p className="text-2xl font-black">
              {plans.filter((p) => p.currentDay >= p.totalDays).length}
            </p>
      ...
      <div className="bg-gradient-to-r from-primary/5 via-primary/10 to-primary/5 border border-primary/10 rounded-2xl p-6 space-y-4">
        ...
        <div className="flex flex-wrap gap-2">
          {DAILY_READING.passages.map((p, i) => (
            <button
              key={i}
              onClick={() => navigate('/reader/19/119')}
      ...
      {showForm && (
        <div className="bg-card border-2 border-primary/20 rounded-2xl p-6 space-y-4 shadow-lg">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-1">
              <label htmlFor="plan-desc" className="text-sm font-bold">
                Descrição
              </label>
              <Input
                id="plan-desc"
            ...
            <div className="flex gap-4 items-end">
              <div className="space-y-1 w-36">
                <label htmlFor="plan-days" className="text-sm font-bold">
                  Duração (dias)
                </label>
                <Input
                  id="plan-days"
      ...
      <div className="flex gap-1 bg-muted p-1 rounded-xl w-fit">
        {[
          ...
          { key: 'active' as const, label: 'Em Andamento', count: activePlans.length },
          {
            ...
            label: 'Finalizados',
            count: plans.filter((p) => p.currentDay >= p.totalDays).length,
          },
        ].map((tab) => (
          <button
            key={tab.key}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {filtered.map((plan) => (
          <div
            ...
            className={
              justCreated === plan.id
                ? 'ring-2 ring-green-500/50 rounded-2xl animate-in fade-in zoom-in-95 duration-500'
                : ''
            }
          >
