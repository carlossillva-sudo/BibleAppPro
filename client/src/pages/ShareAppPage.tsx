...
export const ShareAppPage: React.FC = () => {
  ...
  const shareToWhatsApp = () => {
    const text = encodeURIComponent(
      '🌟 Minha jornada bíblica ficou muito mais profunda com o BibleAppPro!\n\nExperimente você também: ' +
        qrValue
    );
  ...
  const shareToFacebook = () => {
    window.open(
      `https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(qrValue)}`,
      '_blank'
    );
  };
  ...
  const shareToTwitter = () => {
    const text = encodeURIComponent(
      'Minha jornada bíblica ficou muito mais profunda com o BibleAppPro! Experimente você também:'
    );
    window.open(
      `https://twitter.com/intent/tweet?text=${text}&url=${encodeURIComponent(qrValue)}`,
      '_blank'
    );
  };
  ...
  const shareToTelegram = () => {
    const text = encodeURIComponent(
      'Minha jornada bíblica ficou muito mais profunda com o BibleAppPro! ' + qrValue
    );
    window.open(`https://t.me/share/url?url=${encodeURIComponent(qrValue)}&text=${text}`, '_blank');
  };
        ...
        <div className="lg:col-span-1 bg-white dark:bg-zinc-900 border-2 border-slate-100 dark:border-zinc-800 rounded-[40px] p-8 flex flex-col items-center justify-center space-y-8 shadow-sm">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-sm text-muted-foreground font-medium">
              Mostre no seu celular para alguém escanear instantaneamente.
            </p>
          </div>
          <Button
            variant="outline"
            className="w-full h-12 rounded-2xl gap-2 font-bold bg-slate-50 hover:bg-slate-100 border-2 text-slate-700"
          >
            ...
            <div className="relative z-10 space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-blue-100 font-medium">
                  Ao compartilhar, você ajuda o BibleAppPro a chegar a mais pessoas buscando luz e
                  orientação.
                </p>
              </div>
              ...
              <div className="flex flex-wrap gap-4 pt-4 border-t border-white/10">
                <div className="flex items-center gap-4 text-sm font-bold">
                  ...
                  <button
                    ...
                    className="h-10 w-10 bg-white/10 hover:bg-white/20 rounded-full flex items-center justify-center transition-all"
                  >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-amber-50 dark:bg-amber-900/10 border-2 border-amber-100 dark:border-amber-800 rounded-[32px] p-8 space-y-4">
              ...
              <p className="text-sm text-muted-foreground font-medium leading-relaxed">
                Curiosidade: Usuários que compartilham o App tendem a completar 40% mais planos de
                leitura mensais. Inspire outros agora!
              </p>
            </div>
            ...
            <div className="bg-slate-50 dark:bg-zinc-800 border-2 border-slate-100 dark:border-zinc-700 rounded-[32px] p-8 space-y-4">
              ...
              <p className="text-sm text-muted-foreground font-medium leading-relaxed">
                Suas indicações ajudam a manter o BibleAppPro acessível para cristãos em todo o
                mundo. Obrigado por fazer parte disso!
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-zinc-50 dark:bg-zinc-800/50 rounded-[40px] p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8 border-2 border-zinc-100 dark:border-zinc-800">
        <div className="space-y-3">
          ...
          <p className="text-muted-foreground font-medium">
            Junte-se a milhares de cristãos que usam o BibleAppPro diarimente.
          </p>
        </div>
        <Button
          variant="outline"
          className="h-14 px-10 rounded-2xl border-2 font-black gap-2 hover:bg-zinc-100 dark:hover:bg-zinc-700"
        >
